 ...
 * @property {string} helpText - bot message on command /help
 * @property {string} smile - bot response on sticker
 * 
 */

const botMsg = {
    /**
     * Set bot text on command /start
     * @param {string} userName - user name
     */
    set startText(userName) {
        this._start = `Здравствуйте, ${userName}. Напишите слово или словосочетание, и я проверю его по орфографическому словарю на сайте «Грамота.ру».\n
    Для справки — команда /help`;
    },
    /**
     * Get bot text on command /start
     * @returns {string}
     */
    get startText() {
        return this._start;
